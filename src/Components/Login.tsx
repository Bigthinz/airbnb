    ...
    <div>
      <div className='hidden md:block'>
        ...
        <div className='flex justify-center m-auto sm:w-5/6'>
           <div className='sm:w-full lg:w-[60%]   md:border-2 rounded-xl md:mt-[4rem]'>
                    ...
                    <div className='border-2 rounded-md mb-2'>
                      <div className='border-b-2 p-2 '>
                        <div className=''>
                          ...
                          <input type="text" placeholder='email' name='country' className='focus:border-blue-400 focus:border-2 focus:rounded-md outline-none w-full h-[3rem] p-2 roounded '/>
                        </div>
                      </div>
                      <div className='p-2'>
                        <label htmlFor="number">Phone number</label>
                        <input type="text"  placeholder='password' name='number' className='outline-none w-full h-[3rem] p-2 roounded '/>
                      </div>
                    </div>
